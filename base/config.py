...
class Config():
    def __init__(self, config_file=config_file_path):
        ...
        # Milvus 数据库名
        self.MILVUS_DATABASE_NAME = self.config.get('milvus', 'database_name', fallback='product_kb')
        # Milvus 集合名
        self.MILVUS_COLLECTION_NAME = self.config.get('milvus', 'collection_name', fallback='product_rag')
        ...
        self.VALID_SOURCES = eval(self.config.get('app', 'valid_sources', fallback=["product"]))
        # 日志文件路径
