...
# 创建应用实例
app = FastAPI(title="强脑科技产品知识问答API", description="集成MySQL与RAG的智能假肢产品综合知识问答")
...
GREETING_PATTERNS = [
    {
        ...
        "response": "你好！我是强脑科技产品知识助手，可为您解答智能假肢与仿生手相关问题，很高兴为您服务！"
    },
    {
        "pattern": r"^(你是谁|您是谁|你叫什么|你的名字|who are you)",
        "response": "我是强脑科技产品知识助手，专注于智能假肢、仿生手与康复辅具相关的产品综合知识解答。"
    },
    {
        "pattern": r"^(在吗|在不在|有人吗)",
        "response": "我在！我是强脑科技产品知识助手，随时为您解答产品相关问题！"
    },
    {
        "pattern": r"^(干嘛呢|你在干嘛|做什么)",
        "response": "我正在待命，随时为您解答假肢与仿生手产品知识！有什么我可以帮您的？"
    }
]
